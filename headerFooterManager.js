            ...
            <div class="max-w-7xl mx-auto px-6">
                <div class="flex items-center justify-between h-16 md:h-20">
                    ...
                    <a href="/" class="flex items-center gap-x-3">
                        ...
                        <div class="font-semibold text-lg md:text-xl tracking-tight">Leon Benjamignan</div>
                    </a>

                    <!-- Right side: Email + Hamburger -->
                    <div class="flex items-center gap-x-3">
                        <a href="mailto:leon.benjamignan@hey.com" 
                           class="hidden sm:inline-flex items-center px-5 py-2 bg-[#0D9488] hover:bg-[#0F766E] text-white text-sm font-semibold rounded-2xl transition-all active:scale-[0.985]">
                            Email me
                        </a>
